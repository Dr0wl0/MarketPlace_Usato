...
@ControllerAdvice
public class ListingGlobalException {

    @ExceptionHandler(ListingNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handlerBookNotFoundException(ListingNotFoundException e ){
        return new ResponseEntity<>(getRet("404", "l'annuncio richiesto non è presente sulla base dati" ), HttpStatus.NOT_FOUND);
    }
